            ...
            <div className='flex flex-wrap  mt-6 max-w-6xl'>
              {
                posts.filter((post) =>post.image_urls.length > 0).map((post)=>(
                  ...
                  {post.image_urls.map((image, index)=>(
                    <Link target='_blank' to={image} key={index} className='relative group mx-0.5 rounded-xl'>
                    <img src={image} key={index} className='w-64 aspect-video object-cover rounded-xl' alt="" />
