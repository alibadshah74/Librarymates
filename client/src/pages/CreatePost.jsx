...
import { AArrowUpIcon, Image, X } from 'lucide-react'
    ...
    <div className='main-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl max-auto p-6'>  
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4'>
            ...
            {/* Text Area  */}
            <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' placeholder="What's happening?" id="" onChange={(e) =>setContent(e.target.value)} value={content}/>
              ...
              images.length > 0 && <div className='flex flex-wrap gap-2 mt-4'>
                {images.map((image, i) =>(
                  <div key={i} className='relative group'>
                    <img src={URL.createObjectURL(image)} className='h-20 round-md' alt="" />
            ...
            <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
              <label htmlFor="images" className='flext items center gap-2 text-sm text-gray-500 hover:text-gray-700 transition cursor-pointer'>
