...
export const updateUserData = async (req, res) => {
    try {
        ...
        if (tempUser.username !== username) {
            ...
            if (user) {
                // we will not change the username if it is alredy taken
...
export const unfollowUser = async (req, res) => {
    try {
        ...
        const toUser = await User.findById(id);
        toUser.followers = toUser.followers.filter(ser => user !== userId);
        await toUser.save();
...
export const sendConnectionRequest = async (req, res) => {
    try {
        ...
        // Check if users allredy connected
        ...
        if(!connection){
            ...
            return res.json({ success: false, message: 'You are already connected of this user'})
        }

        res.json({ success: false, message: 'You are already connected of this user'})
